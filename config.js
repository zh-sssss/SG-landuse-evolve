const storyConfig = {
  ...
  chapters: [
    ...
    },
    {
      ...
      description: "<span class='metric-equation'><span><i>LandUseChange</i><sub>t1→t2</sub>(%) =</span><span class='equation-fraction'><span><i>A</i>(<i>LU</i><sub>t1</sub> ≠ <i>LU</i><sub>t2</sub>)</span><span><i>A</i>(<i>C</i><sub>t1</sub> ∩ <i>C</i><sub>t2</sub>)</span></span><span>× 100</span></span><span class='equation-key'><i>A</i> = area; <i>LU</i><sub>t</sub> = analytical land-use group at time <i>t</i>; <i>C</i><sub>t</sub> = area covered by a mapped category at time <i>t</i>.</span>The formula is calculated within each 500 m cell for 2003–2014, 2014–2025 and 2003–2025. Thus, 40% means that four-tenths of the comparable mapped area changed analytical land-use group. <strong>Temporal note:</strong> plan editions are statutory snapshots rather than construction dates, and implementation may follow later. Street View dates are observation years and do not correspond directly to the three plan editions.",
      companion: {
        title: "Land-use change, 2003–2014",
        description: "<span class='analysis-points'><span>Higher change shares cluster around Punggol–Seletar, the Tengah–Jurong belt, Changi East and the southern port edge.</span><span>Compared with 2014–2025, change is more pronounced in the north-east; reserve-to-employment and reserve-to-residential shifts are especially common.</span></span>"
      },
      location: { center: [103.8198, 1.3521], zoom: 10.8, bearing: 0, pitch: 0 },
    ...
    },
    {
      ...
      description: "<span class='analysis-points'><span>In the 2003–2025 endpoint comparison, higher change shares are concentrated in the western growth belt, Punggol–Seletar, the eastern planning fringe and the southern waterfront.</span><span>Prominent category transitions in these concentrations involve reserve, employment, residential and park uses. The 2003–2025 result is used to select the Change Concentrated cells.</span></span>",
      location: { center: [103.8198, 1.3521], zoom: 10.8, bearing: 0, pitch: 0 },
    ...
    },
    {
      ...
      description: "The top 15% of cells with at least 20% comparable mapped coverage in both 2003 and 2025 form the hotspot screening layer (minimum change share: 39.7%). Hotspot classification depends only on the share of mapped area that changed planned land-use group. The three cases are selected from this layer based on historical-imagery availability, visual comparability and geographic spread. Dominant-transition fields identify the largest category shift by area. Interval shares are separate comparisons and are not additive.",
      location: { center: [103.8198, 1.3521], zoom: 10.8, bearing: 0, pitch: 0 },
    ...
    },
    {
      ...
      description: "In this selected cell, <strong>70.7%</strong> of the comparable mapped area changed planned land-use group from 2003 to 2025; the largest changed-area transition was Residential → Commercial and mixed use.<br><strong>By interval:</strong> 2003–2014, 70.8%; 2014–2025, 1.4%. The 2011 view shows a new road within an open construction landscape. By 2015, housing defines the western edge, while planting remains young. In 2025, mature trees and a continuous footway improve shade and enclosure, although the opposite edge remains open and the corridor stays road-dominated.",
    ...
    },
    {
      ...
      description: "In this selected cell, <strong>53.4%</strong> of the comparable mapped area changed planned land-use group from 2003 to 2025; the largest changed-area transition was Residential → Transport and infrastructure.<br><strong>By interval:</strong> 2003–2014, 52.2%; 2014–2025, 5.0%. The 2008 and 2015 views both retain an open green frontage, placing the visible redevelopment mainly after 2015. By 2024, housing and community-scale development create a denser edge, but the continuous walls then separate the street from the new development.",
    ...
    },
    {
      ...
      description: "In selected cell r039c031, <strong>41.6%</strong> of the comparable mapped area changed planned land-use group from 2003 to 2025; the largest changed-area transition was Reserve site → Institutional and community.<br><strong>By interval:</strong> 2003–2014, 27.3%; 2014–2025, 16.2%. The 2009 construction site becomes Big Box by 2015, marking the main visible shift from vacant frontage to an active building edge. By 2025, the building is Perennial Business City and planting is more mature.",
    ...
    },
    {
      ...
      description: "The plan comparison identifies categorical changes in planned land use. Street View independently documents visible changes in frontage, enclosure, greenery, crossings and pedestrian space from selected viewpoints. Read together, they can indicate whether physical change is visible, underway or not visible at those locations, but they cannot verify plan implementation or establish causation.",
      location: { center: [103.8198, 1.3521], zoom: 10.8, bearing: 0, pitch: 0 },
      visibleLayers: ["change-concentrated", "svi-points"]
    }
  ]
